...
{
    public abstract class omzoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static omzoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(omzoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<omzoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<omzoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<omzoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<omzoDbContext, Task<T>> func)
        {
            T result;
